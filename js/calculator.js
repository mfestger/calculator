/**
 * Created by michaelfestger on 4/18/17.
 */
'use strict'
...
// document.write('<style type="text/css"> body{background-image:url("img/' + (1 + Math.floor(Math.random() * 14)) + '.jpg") ;}</style>');
...
function setWallpaper(){
    var backgroundImages = shuffle(imageArray);
    var newWallPaper = backgroundImages[0];
    document.body.setAttribute("style", "background-image: url(http://i.imgur.com/" + newWallPaper + ".jpg");
    function shuffle (a) {
...
var shuffleButton = document.querySelector("#wallpaperGenerator");

shuffleButton.addEventListener('click', setWallpaper);
